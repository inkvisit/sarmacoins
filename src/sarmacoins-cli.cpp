...
// Copyright (c) 2009-2015 The SarmaCoins developers
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  SarmaCoins-cli [options] <command> [params]  " + _("Send command to SarmaCoins Core") + "\n" +
                  "  SarmaCoins-cli [options] help                " + _("List commands") + "\n" +
                  "  SarmaCoins-cli [options] help <command>      " + _("Get help for a command") + "\n";
