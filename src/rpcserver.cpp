...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "SarmaCoins server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* SarmaCoins features */
    { "SarmaCoins",               "masternode",             &masternode,             true,      true,       false },
    { "SarmaCoins",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "SarmaCoins",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "SarmaCoins",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "SarmaCoins",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "SarmaCoins",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "SarmaCoins",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "SarmaCoins",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
