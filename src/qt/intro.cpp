...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SarmaCoins Core"),
     ...
     * override -datadir in the SarmaCoins.conf file in the default data directory
     * (to be consistent with SarmaCoinsd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
