    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SarmaCoins Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About SarmaCoins Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SarmaCoins Core is shutting down...") + "<br /><br />" +
