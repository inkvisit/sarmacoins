    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SarmaCoins Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SarmaCoins address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SarmaCoins: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SarmaCoins Core"), this);
    aboutAction->setStatusTip(tr("Show information about SarmaCoins Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SarmaCoins"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SarmaCoins addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SarmaCoins addresses"));
    ...
    openAction->setStatusTip(tr("Open a SarmaCoins: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SarmaCoins Core help message to get a list with possible SarmaCoins command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SarmaCoins Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SarmaCoins network", "", count));
}
...
{
    QString strTitle = tr("SarmaCoins Core"); // default title
