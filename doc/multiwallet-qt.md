...
Only requiring some minor changes is SarmaCoins.cpp.
...
Changes to SarmaCoins.cpp
----------------------
SarmaCoins.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
